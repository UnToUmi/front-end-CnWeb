...
import { filters, singleFilter } from './FillterData'
...
const sortOptions = [
    { name: 'Price: Low to High', href: `?sort="price_low"`, current: false },
    { name: 'Price: High to Low', href: `?sort="price_high"`, current: false },
]
                ...
                <main className="mx-auto  px-4 sm:px-6 lg:px-20">
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            ...
                            {/* Product grid */}
                            <div className="lg:col-span-4 flex flex-wrap w-full">
                                <div className=' justify-center bg-white py-5'></div>
